...
if df_validos is not None:
    ...
    with abas[0]:
        ...
        st.caption("Cada card compara a performance do dia no período com a média histórica do mesmo dia. A hora de pico se refere aos totais do período filtrado.")
